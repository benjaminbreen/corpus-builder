...
OCR_PATTERNS = [
    ...
    # Additional long-s patterns for 17th century texts
    (r'\bleaft\b', 'least'),
    (r'\bAmidft\b', 'Amidst'),
    (r'\bamidft\b', 'amidst'),
    (r'\bMajeft', 'Majest'),  # Majesties, Majesty
    (r'\bmajeft', 'majest'),
    (r'\bPhilofophy', 'Philosophy'),
    (r'\bphilofophy', 'philosophy'),
    (r'\bprofper', 'prosper'),
    (r'\bKeftaur', 'Restor'),  # Restoration
    (r'\bKeftanration', 'Restoration'),  # alternate OCR error
    (r'\bReftaur', 'Restor'),
    (r'\bReftoration', 'Restoration'),
    (r'\bKoyal\b', 'Royal'),
    (r'\bkoyal\b', 'royal'),
    (r'\bprefumpt', 'presumpt'),  # presumptuous
    (r'\bconfider', 'consider'),
    (r'\bdefir', 'desir'),  # desire, desired
    (r'\bprefent', 'present'),
    (r'\breprefent', 'represent'),
    (r'\bpurfue', 'pursue'),
    (r'\bpurfu', 'pursu'),
    (r'\bperfu', 'persu'),
    (r'\bpaffage', 'passage'),
    ...
    (r'\bexpreff', 'express'),
    (r'\bimpreff', 'impress'),
    (r'\bfuppreff', 'suppress'),
    (r'\bdiftreff', 'distress'),
    (r'\bbleff', 'bless'),
    (r'\bgueff', 'guess'),
    (r'\bleff\b', 'less'),
    (r'\bunleff', 'unless'),
    ...
    (r'\bfoul\b', 'soul'),
    (r'\breafon', 'reason'),  # reasoning, reasons, etc.
    (r'\bunderftand', 'understand'),
    (r'\bmoft\b', 'most'),
    (r'\bfpeed', 'speed'),
    (r'\bdiftribut', 'distribut'),  # distributed, distribution
    (r'\bdiftinct', 'distinct'),
    (r'\bdifcover', 'discover'),
    (r'\bdifpof', 'dispos'),  # disposed, disposition
    (r'\bdifcern', 'discern'),
    (r'\bfpecies\b', 'species'),
    (r'\bfpecial', 'special'),
    (r'\bfpeak', 'speak'),
    (r'\bfpoken\b', 'spoken'),
    (r'\bfpeech', 'speech'),
    ...
    (r'\bftreet\b', 'street'),
    (r'\bftrange', 'strange'),
    (r'\bftrength', 'strength'),
    (r'\bftrict', 'strict'),
    (r'\bftrike', 'strike'),
    (r'\bftruct', 'struct'),  # structure, instruction
